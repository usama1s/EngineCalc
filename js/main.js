...
for (var i = 0; i < inputlength; i++) {
  document
    .querySelectorAll(".position_data")
    [i].addEventListener("input", function (event) {
      ...
      const ga = `\\[\\left[\\frac{${inp7} + ${inp1} + ${inp8}}{3} \\right]\\] = ${groupA}`;
      $("#ga").text(ga);
      const gb = `\\[\\left[\\frac{${inp8} + ${inp1} + ${inp2}}{3} \\right]\\] = ${groupB}`;
      $("#gb").text(gb);
      const gc = `\\[\\left[\\frac{${inp1} + ${inp2} + ${inp3}}{3} \\right]\\] = ${groupC}`;
      $("#gc").text(gc);
      const gd = `\\[\\left[\\frac{${inp3} + ${inp4} + ${inp5}}{3} \\right]\\] = ${groupD}`;
      $("#gd").text(gd);
      const ge = `\\[\\left[\\frac{${inp4} + ${inp5} + ${inp6}}{3} \\right]\\] = ${groupE}`;
      $("#ge").text(ge);
      const gf = `\\[\\left[\\frac{${inp5} + ${inp6} + ${inp7}}{3} \\right]\\] = ${groupF}`;
      $("#gf").text(gf);
